...
AProjectile::AProjectile()
{
	...
	TrailParticlesComponent = CreateDefaultSubobject<UParticleSystemComponent>(TEXT("Smoke Trail"));
...
void AProjectile::BeginPlay()
{
	...
	if(LanuchSound){
		UGameplayStatics::PlaySoundAtLocation(this,LanuchSound,GetActorLocation());
	}
}
...
void AProjectile::OnHit(UPrimitiveComponent* HitComp,AActor* OtherActor,UPrimitiveComponent* OtherComp,FVector NormalImpluse,const FHitResult& Hit)
{
	...
	UClass* MyDamageType = UDamageType::StaticClass();
